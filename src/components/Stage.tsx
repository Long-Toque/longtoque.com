...
export function Stage() {
  ...
  const tabs = [
    ...
    { id: 'grad-school-improv', label: 'Grad School Improv' },
  ];

  // Images for each production
  const didiImages = [
        ...
        <div className="bg-[#6B2828] rounded-b-lg p-6 md:p-8">
          {activeTab === 'didi' && (
            <div className="space-y-8">
              <ImageCarousel images={didiImages} />
              
              <div className="text-white font-sans space-y-4">
                <h3 className="text-2xl font-serif text-gray-200">About DIDI</h3>
          ...
          {activeTab === 'people-you-may-know' && (
            <div className="space-y-8">
              <ImageCarousel images={peopleYouMayKnowImages} />
              
              <div className="text-white font-sans space-y-4">
                <h3 className="text-2xl font-serif text-gray-200">About People You May Know</h3>
                <p className="leading-relaxed">
              ...
              <UpcomingEvents calendarId="people-you-may-know-calendar@example.com" title="Upcoming Shows" />
            </div>
          )}

          {activeTab === 'grad-school-improv' && (
            <div className="space-y-8">
              <ImageCarousel images={gradSchoolImprovImages} />
              
              <div className="text-white font-sans space-y-4">
                <h3 className="text-2xl font-serif text-gray-200">About Grad School Improv</h3>
                <p className="leading-relaxed">
              ...
              <UpcomingEvents calendarId="grad-school-improv-calendar@example.com" title="Upcoming Shows" />
            </div>
          )}
        </div>
      </div>
